...
for i in range(0, 100):
    ...
    pygame.draw.polygon(sun, (154, 206, 235), [(0,0),(500,0),(500,400),(0,400)])
    sun.set_colorkey((154, 206, 235))
...
pygame.draw.ellipse(uni, LIGHT_PINK, (184, 638, 45, 25))
pygame.draw.ellipse(uni, TAN, (180, 655, 50, 23))
pygame.draw.ellipse(uni, PURPLE, (177, 661, 35, 18))
pygame.draw.ellipse(uni, LIME, (180, 670, 53, 20))
pygame.draw.ellipse(uni, PINK, (170, 675, 40, 20))
pygame.draw.ellipse(uni, LIME, (166, 682, 42, 18))
pygame.draw.ellipse(uni, PINK, (184, 685, 40, 16))
pygame.draw.ellipse(uni, PURPLE, (160, 686, 40, 18))
pygame.draw.ellipse(uni, PURPLE, (164, 690, 45, 20))
pygame.draw.ellipse(uni, LIGHT_PINK, (163, 696, 55, 25))
pygame.draw.ellipse(uni, TAN, (170, 700, 50, 20))
pygame.draw.ellipse(uni, LIME, (176, 700, 48, 14))
pygame.draw.ellipse(uni, LIME, (157, 708, 48, 14))
pygame.draw.ellipse(uni, PURPLE, (175, 715, 40, 18))
pygame.draw.ellipse(uni, PINK, (155, 720, 50, 20))
pygame.draw.ellipse(uni, LIME, (179, 726, 48, 18))
pygame.draw.ellipse(uni, LIGHT_PINK, (157, 715, 55, 25))
pygame.draw.ellipse(uni, TAN, (180, 715, 50, 20))
pygame.draw.ellipse(uni, PURPLE, (160, 730, 50, 18))

#UNICORN_BODY
pygame.draw.ellipse(uni, WHITE, (200, 600, 180, 90))
pygame.draw.polygon(uni, WHITE, [[300, 650], [365, 650], [365, 550], [320, 550]])
pygame.draw.polygon(uni, WHITE, [[225, 650], [240, 650], [240, 750], [225, 750]])
pygame.draw.polygon(uni, WHITE, [[350, 650], [362, 650], [362, 740], [350, 740]])
pygame.draw.polygon(uni, WHITE, [[315, 650], [330, 650], [330, 750], [315, 750]])
pygame.draw.polygon(uni, WHITE, [[260, 650], [272, 650], [272, 740], [260, 740]])
pygame.draw.ellipse(uni, WHITE, (337, 535, 67, 28))
pygame.draw.ellipse(uni, WHITE, (317, 520, 60, 50))
pygame.draw.polygon(uni, PINK, [[340, 525], [354, 524], [355, 460]])

#EYE
pygame.draw.ellipse(uni, BRPURPLE, (345, 535, 19, 19))
pygame.draw.ellipse(uni, WHITE, (348, 538, 12, 6))
pygame.draw.ellipse(uni, BLACK, (355, 541, 7, 7))

#HAIR
pygame.draw.ellipse(uni, PINK, (314, 516, 40, 20))
pygame.draw.ellipse(uni, PINK, (300, 525, 44, 18))
pygame.draw.ellipse(uni, LIGHT_PINK, (314, 530, 30, 17))
pygame.draw.ellipse(uni, PINK, (316, 516, 40, 20))
pygame.draw.ellipse(uni, LIGHT_PINK, (284, 533, 45, 25))
pygame.draw.ellipse(uni, TAN, (290, 545, 50, 23))
pygame.draw.ellipse(uni, LIME, (280, 560, 53, 20))
pygame.draw.ellipse(uni, PURPLE, (280, 575, 40, 20))
pygame.draw.ellipse(uni, LIGHT_PINK, (263, 580, 55, 25))
pygame.draw.ellipse(uni, TAN, (270, 585, 50, 20))
pygame.draw.ellipse(uni, LIME, (280, 590, 38, 14))
pygame.draw.ellipse(uni, PURPLE, (270, 593, 40, 18))
